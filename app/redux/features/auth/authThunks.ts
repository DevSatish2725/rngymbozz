...
import { LoginPayload, LoginResponse, SignupPayload, SignupResponse } from "./authTypes";
...
const signup = createAsyncThunk<SignupResponse, SignupPayload, {rejectValue: string}>(
  "auth/signup",
